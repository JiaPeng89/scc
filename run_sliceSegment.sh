  ...
  do 
	 ...
	 do
		...
		do 
		   ...
		   do 
		      ./TAppEncoderStatic -c $cfg.cfg -c persequence/${s}_444.cfg --FramesToBeEncoded=$f --SliceMode=$SliceMode --SliceSegmentMode=$SliceSegmentMode --SliceArgument=${SliceArgument[$sa]} --SliceSegmentArgument=${SliceSegmentArgument[$ssa]} --LFCrossSliceBoundaryFlag=$LFCrossSliceBoundaryFlag --IntraBlockCopyEnabled=0 --PaletteMode=0 -b ${dir}/ALI_SLICESEGMENT_ai_${jarray[$j]}_${array[$i]}_0.bin
	              ./TAppEncoderStatic -c $cfg.cfg -c persequence/${s}_444.cfg --FramesToBeEncoded=$f --SliceMode=$SliceMode --SliceSegmentMode=$SliceSegmentMode --SliceArgument=${SliceArgument[$sa]} --SliceSegmentArgument=${SliceSegmentArgument[$ssa]} --LFCrossSliceBoundaryFlag=$LFCrossSliceBoundaryFlag --IntraBlockCopyEnabled=1 --PaletteMode=0 -b ${dir}/ALI_SLICESEGMENT_ai_${jarray[$j]}_${array[$i]}_1.bin
		      ./TAppEncoderStatic -c $cfg.cfg -c persequence/${s}_444.cfg --FramesToBeEncoded=$f --SliceMode=$SliceMode --SliceSegmentMode=$SliceSegmentMode --SliceArgument=${SliceArgument[$sa]} --SliceSegmentArgument=${SliceSegmentArgument[$ssa]} --LFCrossSliceBoundaryFlag=$LFCrossSliceBoundaryFlag --IntraBlockCopyEnabled=0 --PaletteMode=1 -b ${dir}/ALI_SLICESEGMENT_ai_${jarray[$j]}_${array[$i]}_2.bin
		      ./TAppEncoderStatic -c $cfg.cfg -c persequence/${s}_444.cfg --FramesToBeEncoded=$f --SliceMode=$SliceMode --SliceSegmentMode=$SliceSegmentMode --SliceArgument=${SliceArgument[$sa]} --SliceSegmentArgument=${SliceSegmentArgument[$ssa]} --LFCrossSliceBoundaryFlag=$LFCrossSliceBoundaryFlag --IntraBlockCopyEnabled=1 --PaletteMode=1 -b ${dir}/ALI_SLICESEGMENT_ai_${jarray[$j]}_${array[$i]}_3.bin
		   j=`expr $j+1`
           done
        done
        i=`expr $i+1`
