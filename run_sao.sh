#!/bin/bash
output_sao="sao.csv"
echo "FILE,SAO,TestSAODisableAtPictureLevel,SaoEncodingRate,SaoEncodingRateChroma,MaxNumOffsetsPerPic,SAOLcuBoundary">$output_sao
		...
		do 
			...
			do 								
				...
				do
					...
					do	
						./TAppEncoderStatic -c $cfg.cfg -c persequence/${s}_444.cfg --FramesToBeEncoded=$f --SAO=1 --TestSAODisableAtPictureLevel=$TestSAODisableAtPictureLevel --SaoEncodingRate=$SaoEncodingRate --SaoEncodingRateChroma=$SaoEncodingRateChroma  --SAOLcuBoundary=$SAOLcuBoundary --IntraBlockCopyEnabled=0 --PaletteMode=0 -b ${dir}/ALI_SAO_ai_${jarray[$j]}_${s}_${array[$i]}_0.bin 										
						./TAppEncoderStatic -c $cfg.cfg -c persequence/${s}_444.cfg --FramesToBeEncoded=$f --SAO=1 --TestSAODisableAtPictureLevel=$TestSAODisableAtPictureLevel --SaoEncodingRate=$SaoEncodingRate --SaoEncodingRateChroma=$SaoEncodingRateChroma  --SAOLcuBoundary=$SAOLcuBoundary --IntraBlockCopyEnabled=1 --PaletteMode=0 -b ${dir}/ALI_SAO_ai_${jarray[$j]}_${s}_${array[$i]}_1.bin
						./TAppEncoderStatic -c $cfg.cfg -c persequence/${s}_444.cfg --FramesToBeEncoded=$f --SAO=1 --TestSAODisableAtPictureLevel=$TestSAODisableAtPictureLevel --SaoEncodingRate=$SaoEncodingRate --SaoEncodingRateChroma=$SaoEncodingRateChroma  --SAOLcuBoundary=$SAOLcuBoundary --IntraBlockCopyEnabled=0 --PaletteMode=1 -b ${dir}/ALI_SAO_ai_${jarray[$j]}_${s}_${array[$i]}_2.bin
						./TAppEncoderStatic -c $cfg.cfg -c persequence/${s}_444.cfg --FramesToBeEncoded=$f --SAO=1 --TestSAODisableAtPictureLevel=$TestSAODisableAtPictureLevel --SaoEncodingRate=$SaoEncodingRate --SaoEncodingRateChroma=$SaoEncodingRateChroma  --SAOLcuBoundary=$SAOLcuBoundary --IntraBlockCopyEnabled=1 --PaletteMode=1 -b ${dir}/ALI_SAO_ai_${jarray[$j]}_${s}_${array[$i]}_3.bin
						j=`expr $j+1`
					done
						i=`expr $i+1`
				done												
